class CompModFamilyInfo_Agatha_Archer extends AOCFamilyInfo_Agatha_Archer;
...
DefaultProperties
{
	...
	NewPrimaryWeapons(3)=(CWeapon=class'CompModWeapon_Crossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Agatha',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(4)=(CWeapon=class'CompModWeapon_LightCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Agatha',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(5)=(CWeapon=class'CompModWeapon_HeavyCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Agatha',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(6)=(CWeapon=class'CompModWeapon_JavelinMelee',CForceTertiary=(class'CompModWeapon_Buckler_Agatha'))
	NewPrimaryWeapons(7)=(CWeapon=class'CompModWeapon_ShortSpearMelee',CForceTertiary=(class'CompModWeapon_Buckler_Agatha'))
	NewPrimaryWeapons(8)=(CWeapon=class'CompModWeapon_HeavyJavelinMelee',CForceTertiary=(class'CompModWeapon_Buckler_Agatha'))
	...
	NewTertiaryWeapons(2)=(CWeapon=class'CompModWeapon_Buckler_Agatha',bEnabledDefault=false)
