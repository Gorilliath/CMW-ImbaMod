class ImbaModFamilyInfo_Mason_Archer extends AOCFamilyInfo_Mason_Archer;
...
DefaultProperties
{
	...
	NewPrimaryWeapons(3)=(CWeapon=class'ImbaModWeapon_Crossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(4)=(CWeapon=class'ImbaModWeapon_LightCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(5)=(CWeapon=class'ImbaModWeapon_HeavyCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Mason',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(6)=(CWeapon=class'ImbaModWeapon_JavelinMelee',CForceTertiary=(class'ImbaModWeapon_Buckler_Mason'))
	NewPrimaryWeapons(7)=(CWeapon=class'ImbaModWeapon_ShortSpearMelee',CForceTertiary=(class'ImbaModWeapon_Buckler_Mason'))
	NewPrimaryWeapons(8)=(CWeapon=class'ImbaModWeapon_HeavyJavelinMelee',CForceTertiary=(class'ImbaModWeapon_Buckler_Mason'))
	...
	NewTertiaryWeapons(2)=(CWeapon=class'ImbaModWeapon_Buckler_Mason',bEnabledDefault=false)
