class CompModFamilyInfo_Mason_Knight extends AOCFamilyInfo_Mason_Knight;
...
DefaultProperties
{
	...
	NewTertiaryWeapons(1)=(CWeapon=class'CompModWeapon_TowerShield_Mason')
	NewTertiaryWeapons(2)=(CWeapon=class'CompModWeapon_Heater_Mason',bEnabledDefault=true)
	NewTertiaryWeapons(3)=(CWeapon=class'CompModWeapon_Kite_Mason')
	NewTertiaryWeapons(4)=(CWeapon=class'CompModWeapon_Buckler_Mason')
