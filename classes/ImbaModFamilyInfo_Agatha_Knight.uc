class ImbaModFamilyInfo_Agatha_Knight extends AOCFamilyInfo_Agatha_Knight;
...
DefaultProperties
{
    ...
    NewTertiaryWeapons(1)=(CWeapon=class'ImbaModWeapon_TowerShield_Agatha')
    NewTertiaryWeapons(2)=(CWeapon=class'ImbaModWeapon_Heater_Agatha',bEnabledDefault=true)
    NewTertiaryWeapons(3)=(CWeapon=class'ImbaModWeapon_Kite_Agatha')
    NewTertiaryWeapons(4)=(CWeapon=class'ImbaModWeapon_Buckler_Agatha')
